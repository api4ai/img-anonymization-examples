...
$data = ['url' => 'https://storage.googleapis.com/api4ai-static/samples/img-anonymization-0.jpg'];
...
echo "💬 Hidden objects:";
echo json_encode($raw_response['results'][0]['entities'][1]['objects'], JSON_PRETTY_PRINT);
